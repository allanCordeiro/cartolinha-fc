...
import (
	...
	httphandler "github.com/AllanCordeiro/cartolinha/ms-consolidador/internal/infra/http"
	"github.com/AllanCordeiro/cartolinha/ms-consolidador/internal/infra/kafka/consumer"
	"github.com/AllanCordeiro/cartolinha/ms-consolidador/internal/infra/repository"
...
func main() {
	...
	dtb, err := sql.Open("mysql", "root:root@tcp(mysql:3306)/cartolinha?parseTime=true")
	if err != nil {
		panic(err)
	}
	defer dtb.Close()
