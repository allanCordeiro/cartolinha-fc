...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0003_alter_match_team_a_goal_alter_match_team_b_goal'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('goal', 'Goal'), ('assit', 'Assist'), ('yellow_card', 'Yellow Card'), ('RED_card', 'Red Card')], max_length=50)),
